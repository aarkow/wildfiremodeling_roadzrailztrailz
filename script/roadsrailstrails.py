...
try:
    ...
    arcpy.analysis.PairwiseBuffer(userfireperimeters,"Perims_10kmBuff","10 Kilometers","ALL",None,"GEODESIC","0 DecimalDegrees")
...
try:
    ...
    arcpy.analysis.PairwiseDissolve("trans_usgs_usfs_containment",(os.path.join(output_fgdb,"trans_usgs_usfs_containment_"+datetime)),"Source;Width",None,"MULTI_PART","")
